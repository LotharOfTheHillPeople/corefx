...
namespace System.Data.SqlTypes
{
    sealed public class SqlFileStream : System.IO.Stream
    {
            ...
            )
        {
            ...
            //IntPtr hscp;
            //TODO: Bid.ScopeEnter(out hscp, "<sc.SqlFileStream.ctor|API> %d# access=%d options=%d path='%ls' ", ObjectID, (int)access, (int)options, path);
        ...
        static private string GetFullPathInternal(string path)
        {
            ...
            // normalize the path
            //UnsafeNativeMethods.SafeGetFullPathName(path);
            ...
            )
        {
           ...
           // UInt32 dwCreateDisposition = 0;
            ...
            System.IO.FileMode modeAccess = System.IO.FileMode.OpenOrCreate;
            ...
            switch (access)
            {
                case System.IO.FileAccess.Read:
                   // nDesiredAccess |= UnsafeNativeMethods.FILE_READ_DATA;
                    ...
                    modeAccess = System.IO.FileMode.Open;
                    break;
                ...
                case System.IO.FileAccess.Write:
                    ...
                    modeAccess = System.IO.FileMode.Truncate;
                    break;
                ...
                default:
                   ...
                   // nDesiredAccess |= UnsafeNativeMethods.FILE_READ_DATA | UnsafeNativeMethods.FILE_WRITE_DATA;
                    shareAccess = System.IO.FileShare.Delete | System.IO.FileShare.Read;
                    // dwCreateDisposition = (uint)UnsafeNativeMethods.CreationDisposition.FILE_OVERWRITE;
                    modeAccess = System.IO.FileMode.OpenOrCreate;
                    break;
            }
            ...
            //        false, false);
              ...
              //  UnsafeNativeMethods.OBJECT_ATTRIBUTES oa;
                ...
                try
                {
                    ...
                    m_fs = new System.IO.FileStream(path, modeAccess, access, shareAccess, DefaultBufferSize, ((options & System.IO.FileOptions.Asynchronous) != 0));
                }
                finally
                {
                    if (bRevertAssert)
            ...
            catch
            {
                ...
                //Handle error creating filestream here
                    //switch (retval)
                    //{
                    //    case 0:
                    //        break;
